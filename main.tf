...
- CloudTrail logs are stored in an encrypted S3 bucket.
- The organization name and environment are configurable via variables.
- Logging centralization is not implemented as per the user input.