```hcl
# main.tf
# Terraform configuration for setting up a multi-region AWS environment with CloudTrail logging.
...
- CloudTrail logs are stored in an S3 bucket created by this script.
