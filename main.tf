...
- Logs are not centralized into a logging account, as per user input.
- Default values for project name, owner, and email are set to "hello" based on user input. Update these as needed.