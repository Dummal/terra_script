...
2. Create a `terraform.tfvars` file to override any default variable values if needed.
...
- The S3 bucket name for CloudTrail logs is `cloudtrail-logs-bucket` (can be overridden via variables).